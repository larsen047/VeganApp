...
BVApp.views.MainTabPanel = Ext.extend(Ext.TabPanel,{    
    ...
    initComponent: function(){
        ...
        if(BVApp.utils.Settings.language=="en" || BVApp.utils.Settings.language=="de")
        {
            this.passportPanel = new BVApp.views.PassportPanel(); //Hvis Sproget er engelsk eller tysk, skal der vises vegan-pas i bund-menuen
        }
        else
        {
          this.recommendationsPanel = new BVApp.views.RecommendationsPanel(); //Hvis sproget er dansk, vises der anbefalede restauranter
        }
