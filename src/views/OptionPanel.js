        ...
        this.optionsForm = new Ext.form.FormPanel({
            items: [{
                ...
                items:
                 [
                 {
                    label: BVApp.Main.getLangString("OptionsDanish"),
                    value : 'dk',
                    checked: BVApp.utils.Settings.language === 'dk',
                    listeners: {
                        afterrender: function (cmp){
                            cmp.on("check" ,function(cmp){
                                BVApp.utils.AppUtils.alertMessage(BVApp.Main.getLangString("OptionsHint","dk"), BVApp.Main.getLangString("OptionsPleaseRestart","dk"));
                                me.updateOptions();
                            });
                        }
                    }
