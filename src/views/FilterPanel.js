...
BVApp.views.FilterPanel = Ext.extend(Ext.Panel,{
    ...
    buildItems: function(){
        ...
        if(this.type === "restaurants" || this.type === "imbiss" || this.type === "icecafes" || this.type === "cafes")
        {
            if(BVApp.utils.Settings.language !== "")
            { // in english mode only vegan declared is shown <--Fejl....Alle vises PÅ NÆR vegan declared!
                items.push({
