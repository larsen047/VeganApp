BVApp.models.LocationStore = Ext.extend(Ext.data.ArrayStore, {
    ...
    //Afstand til spisestedet i rute-længde!
    updateDistance: function()
    {
        this.each(function(record)
        {
            var origin = new google.maps.LatLng(BVApp.utils.CurrentGeoPosition.latitude,BVApp.utils.CurrentGeoPosition.longitude);
            var destination = new google.maps.LatLng(record.get("lat"),record.get("long"));
...
/*
        //afstand til spisested i fugleflugtslinie!
       updateDistance: function()
       {
